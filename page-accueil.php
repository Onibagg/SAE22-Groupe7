...
<script src="JS\annimation-page-accueil.js"></script>
        ...
        <div class="container-fluid custom mt-3">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-4 text-black">
                    <img name="/Images/Accueil/Key_image.png" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" style="opacity: 0" width="250" height="250" class="d-block lazy">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-3 text-black">
                    <img name="/Images/Accueil/WWW_image.png" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" style="opacity: 0" width="250" height="250" class="d-block lazy">
