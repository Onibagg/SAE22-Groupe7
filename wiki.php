                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <img src="Images\Screen\avenir.png" width="350px">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse2" class="collapse show" data-bs-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <img src="Images\Screen\carte.png" width="350px">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <br> <br>
                                <img class='mt-5' src="Images\Screen\Newuser.png" width="600px">
                            </div>
                            <div class="col text-center">
                                <img class='mt-2' src="Images\Screen\Portail.png" width="500px">
                ...
                <div id="collapse1113999" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <img src="Images\Screen\visuusr.png" width="900px">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse111" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col">
                                <img src="Images\Screen\gp.png" width="600px">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse112" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col">
                                <img src="Images\Screen\dropdown.png" width="400px">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse113" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col">
                                <img src="Images\Screen\suprrgrp.png" width="400px">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse1111" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <img src="Images\Screen\deldir.png" width="400px">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <img src="Images\Screen\upload.png" width="1000px">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="collapse3331" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <img src="Images\Screen\actions.png" width="300px">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div id="collapse2222" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div class="col">
                            <img class="img-border" src="Images\Screen\annuA.jpg" width="350px">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div id="collapse2223" class="collapse" data-bs-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div class="col text-center">
                            <img src="Images\Screen\modif.png" width="500px">
                        </div>
                    </div>
                </div>
            </div>
