...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="card mt-5 me-1">
                <div class="card-body">
                    <p class="display-6">Commentaires:</p>
                    <?php
                    $user = $_SESSION['user'];
                    $data = file_get_contents('Data\groupes.json');
                    $groupes = json_decode($data, true);
                    ...
                    if ($isRH || $isDirection || $isIT || $isFinances || $isProduction) {
                        echo gestion_comments();
                    } else {
                    ?>
                        <div class="text-center">
                            <p class="alert alert-danger" role="alert">/!\ Vous n'avez pas les droits necessaires pour effectuer cette action!</p>
                            <a class="btn btn-outline-primary" href="mailto:need-help@privatevpn.com?subject=Problème lors de l'affichage des Commentaires.&body=Cher Support-Technique,">Demander de l'aide</a>
                        </div>
                    <?php
                    }
                    ?>
